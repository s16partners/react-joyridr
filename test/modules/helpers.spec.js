...
describe("helpers", () => {
  describe("getBrowser", () => {
    ...
    describe("with edge", () => {
      it("should identify properly", () => {
        expect(getBrowser(navigator.userAgent.replace("jsdom", "Edge"))).toBe(
          "edge"
        );
      });
    });
    ...
    describe("with opera", () => {
      it("should identify properly", () => {
        expect(getBrowser(navigator.userAgent.replace("jsdom", "OPR/"))).toBe(
          "opera"
        );
      });
    });
  ...
  describe("isEqual", () => {
    ...
    it("should work with objects", () => {
      ...
      expect(
        isEqual({ name: "One", fn: A }, { name: "One", fn: A })
      ).toBeTrue();
      ...
      expect(
        isEqual({ name: "One", step: { target: "test" } }, { name: "One" })
      ).toBeFalse();

      expect(
        isEqual({ name: "One" }, { name: "One", step: { target: "test" } })
      ).toBeFalse();
    });
