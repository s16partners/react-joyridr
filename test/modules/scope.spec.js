...
describe("modules/scope", () => {
  ...
  describe("with a target with multiple tabbable children", () => {
    ...
    const setScope = scopeInstance => {
      ...
      mocks.findValidTabElements = jest.spyOn(
        scopeInstance,
    ...
    it("should focus the first button", () => {
      ...
      expect(
        wrapper.find(".skip").instance() === document.activeElement
      ).toBeTrue();
    });
    ...
    it("should focus the second button", () => {
      ...
      expect(
        wrapper.find(".back").instance() === document.activeElement
      ).toBeTrue();
    });
    ...
    it("should focus the third button", () => {
      ...
      expect(
        wrapper.find(".primary").instance() === document.activeElement
      ).toBeTrue();
    });
    ...
    it("should focus the last button", () => {
      ...
      expect(
        wrapper.find(".close").instance() === document.activeElement
      ).toBeTrue();
    });
  ...
  describe("with a target with multiple tabbable children and an initial selector", () => {
    ...
    beforeAll(() => {
      wrapper = mount(
        <Tooltip Scope={Scope} setScope={setScope} useSelector={true} />,
        {
          attachTo: document.getElementById("react")
        }
      );
