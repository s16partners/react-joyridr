    ...
    function Store() {
      ...
      _defineProperty(this, "prev", function () {
        var _this$getState4 = _this.getState(),
            ...
            lifecycle = _this$getState4.lifecycle;
      ...
      _defineProperty(this, "next", function () {
        var _this$getState5 = _this.getState(),
            ...
            lifecycle = _this$getState5.lifecycle;
...
function (_React$Component) {
  ...
  _createClass(JoyrideOverlay, [{
    ...
    value: function render() {
      ...
      if (disableOverlay || ![LIFECYCLE.TOOLTIP, LIFECYCLE.INIT].includes(lifecycle)) {
        return null;
      }
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        component: React__default.createElement(JoyrideTooltip, {
          ...
          helpers: helpers,
          index: index,
          isLastStep: this.props.showAll ? false : index + 1 === size,
  ...
  _createClass(Joyride, [{
    ...
    value: function render() {
      ...
      var _this$state4 = this.state,
          ...
          lifecycle = _this$state4.lifecycle,
      ...
      var step = getMergedStep(steps[index], this.props);
      var output;
      console.log(status, action, lifecycle);

      if (status === STATUS.RUNNING && step) {
        output = this.props.showAll && lifecycle !== LIFECYCLE.TOOLTIP ? steps.map(function (st, ind) {
          return !st.disableBeacon && React__default.createElement(JoyrideStep, _extends({
            key: "steppy-".concat(_this2.props.type, "-").concat(ind)
          }, _this2.state, {
            index: ind,
            callback: _this2.callback,
            continuous: continuous,
            showAll: _this2.props.showAll,
            debug: debug,
            setPopper: _this2.setPopper,
            helpers: _this2.helpers,
            step: getMergedStep(st, _this2.props),
            update: _this2.store.update
          }));
        }) : React__default.createElement(JoyrideStep, _extends({}, this.state, {
